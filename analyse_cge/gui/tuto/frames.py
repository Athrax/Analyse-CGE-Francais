...
class CadreMenu(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.bouton_menu_evolution_etat = ctk.CTkButton(master=self, text="Évolution des ministères")
...
class CadreEvolutionUnMinistere(ctk.CTkFrame):
    ...
    def afficher(self):
        CadreEvolutionUnMinistere.tkraise(self)
        print("afficher1")
...
class CadreEvolutionEtat(ctk.CTkFrame):
    ...
    def afficher(self):
        CadreEvolutionEtat.tkraise(self)
        print("afficher2")
